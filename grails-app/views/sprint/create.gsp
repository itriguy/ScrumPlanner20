...
<body>
<a href="#create-sprint" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="create-sprint" class="content scaffold-create" role="main">
    ...
    <g:hasErrors bean="${sprintInstance}">
        <ul class="errors" role="alert">
            <g:eachError bean="${sprintInstance}" var="error">
                <li <g:if
